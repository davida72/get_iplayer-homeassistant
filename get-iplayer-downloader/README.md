...
```yaml
Download Command: "get_iplayer 'Newsround' --channel=CBBC --type=tv --since 168 --sort=available --sortreverse --limit-matches 1 --get --audio-only --output=/downloads --force --overwrite"
Convert Audio: true
...
- `--limit-matches 1` limits search results to just 1 match (the latest episode)
- `--get` downloads only that single matching episode
...
- **Download Command**: Default is `get_iplayer 'Newsround' --channel=CBBC --type=tv --since 168 --sort=available --sortreverse --limit-matches 1 --get --audio-only --output=/downloads --force --overwrite`
...
```yaml
Download Command: "get_iplayer 'Doctor Who' --type=tv --since 720 --sort=available --sortreverse --limit-matches 1 --get --output=/downloads --force --overwrite"
Convert Audio: false
...
```yaml
Download Command: "get_iplayer 'Today Programme' --type=radio --since 168 --sort=available --sortreverse --limit-matches 1 --get --output=/downloads --force --overwrite"
Convert Audio: true
