...
```yaml
Download Command: "get_iplayer 'Newsround' --channel=CBBC --type=tv --since 168 --sort=available --sortreverse --get --audio-only --output=/downloads --force --overwrite"
Convert Audio: true
...
- `--get` downloads the first matching episode (which is now guaranteed to be the latest)
...
- **Download Command**: Default is `get_iplayer 'Newsround' --channel=CBBC --type=tv --since 168 --sort=available --sortreverse --get --audio-only --output=/downloads --force --overwrite`
...
```yaml
Download Command: "get_iplayer 'Doctor Who' --type=tv --since 720 --sort=available --sortreverse --get --output=/downloads --force --overwrite"
Convert Audio: false
...
```yaml
Download Command: "get_iplayer 'Today Programme' --type=radio --since 168 --sort=available --sortreverse --get --output=/downloads --force --overwrite"
Convert Audio: true
